...
class Calculator : CalculatorService {
    override fun add(input1: Double, input2: Double): Double {
        return input1 + input2
    }

    override fun subtract(input1: Double, input2: Double): Double {
        throw UnsupportedOperationException("Method not implemented yet!")
    }

    override fun multiply(input1: Double, input2: Double): Double {
        throw UnsupportedOperationException("Method not implemented yet!")
    }

    override fun divide(input1: Double, input2: Double): Double {
        throw UnsupportedOperationException("Method not implemented yet!")
    }
}
